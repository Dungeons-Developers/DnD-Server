 ...
 * @param {string} ability_scores.body - the ability scores for the new character.
 * @param {string} alignment.body - the alignment for the new character.
 * @param {string} deity.body - the deity for the new character.
 * @param {string} proficient_skills.body - the proficient skills for the new character.
 * @param {string} equipment.body - the equipment for the new character.
 * @param {string} level.body - the level for the new character.
